...
constexpr size_t MAX_DEVICE_ID = 64, MAX_SSID = 32, MAX_WIFI_PASSWORD = 63, MAX_SERVER_HOST = 253,
...
struct Provisioning {
  ...
  char wifiPassword[MAX_WIFI_PASSWORD + 1];
  char serverHost[MAX_SERVER_HOST + 1];
  uint16_t serverPort;
